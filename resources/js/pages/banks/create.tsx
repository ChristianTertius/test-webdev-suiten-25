        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 sm:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-bold text-2xl">Tambah Bank Baru</h1>
                        <p className="text-muted-foreground">Isi form untuk menambahkan bank baru</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-neutral-primary-soft rounded-xl border border-default p-6">
                    ...
                    <div className="flex justify-end gap-3 mt-8">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Menyimpan...' : 'Simpan Bank'}
                        </Button>
                    </div>
                </form>
            </div>
